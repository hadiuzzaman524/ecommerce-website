...
<body>
  ...
  <div style="height: 230px; width: 100%; background-image: url('../image/squarepharma.jpg'); text-align: center; color: white; box-sizing: border-box;padding-top: 50px;  box-shadow: 1px 2px 10px 5px black; margin-bottom: 30px;">
...
<!--end header area -->
      ...
      //showing all product
              ...
              $result=getData();
                 ...
                 if($row['product_companey']=='square'){
