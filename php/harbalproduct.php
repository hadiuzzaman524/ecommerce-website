...
<body>
	...
	<div style="height: 400px; width: 100%; background-image: url('../image/surgical.jpg'); text-align: center; color: white; box-sizing: border-box;padding-top: 100px;  box-shadow: 1px 2px 10px 5px black; margin-bottom: 30px;">



	<h1>Harbal Products</h1>
  <br>
...
<!--end header area -->
      ...
      //showing all product
              ...
              $result=getData();
                 ...
                 if($row['product_category']=='harbal'){


                  test_harbal($row['product_image'],$row['product_name'],$row['product_exp'],$row['product_companey'],$row['product_price'],$row['product_id']);
