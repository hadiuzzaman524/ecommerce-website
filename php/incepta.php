...
<body>
  ...
  <div style="height: 400px; width: 100%; background-image: url('../image/inceptapharma.jpg'); text-align: center; color: black; box-sizing: border-box;padding-top: 200px;  box-shadow: 1px 2px 10px 5px black; margin-bottom: 30px;">
...
<!--end header area -->
      ...
      //showing all product
              ...
              $result=getData();
                 ...
                 if($row['product_companey']=='incepta'){
