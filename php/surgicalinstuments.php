...
<body>
	 ...
	 <div style="height: 400px; width: 100%; background-image: url('../image/surgical_.jpg'); text-align: center; color: white; box-sizing: border-box;padding-top: 100px;  box-shadow: 1px 2px 10px 5px black; margin-bottom: 30px;">



	<h1>Surgical Instuments</h1>
...
<!--end header area -->
      ...
      //showing all product
              ...
              while($row=mysqli_fetch_assoc($result)){
                 ...
                 if($row['product_category']=='surgical'){


                  test_surgical($row['product_image'],$row['product_name'],$row['product_exp'],$row['product_companey'],$row['product_price'],$row['product_id']);
