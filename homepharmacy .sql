...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2020 at 05:35 AM
...
INSERT INTO `contact_us` (`id`, `firstname`, `lastname`, `email`, `description`) VALUES
(1, 'Md', 'Hadiuzzaman', 'e.tutor.codx@gmail.com', '               fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff\r\n\r\n   ');
...
INSERT INTO `final_order` (`id`, `product_id`, `product_quantity`) VALUES
(1, ' 3,  4,  5,  8, ', '2 ,1 ,2 ,1 ,'),
(2, ' 3,  4,  5,  8, ', '2 ,1 ,2 ,1 ,'),
(3, ' 3,  4,  5,  8, ', '2 ,1 ,2 ,1 ,'),
(4, ' 3,  2, ', '1 ,1 ,'),
...
CREATE TABLE `order_` (
  ...
  `paymentoption` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `order_` (`id`, `final_order_id`, `firstname`, `lastname`, `company`, `country`, `housenumber`, `apartment`, `city`, `district`, `postcode`, `phone`, `email`, `notes`, `paymentoption`) VALUES
(1, 1, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', 'i got it quickly', 'cash'),
(2, 2, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', 'i got it quickly', 'cash'),
(3, 3, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', 'i got it quickly', 'cash'),
(4, 4, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', 'i got it quickly', 'cash'),
(5, 5, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', '', 'cash'),
(6, 6, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', 'i got it quickly', 'cash'),
(7, 7, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', 'i got it quickly', 'cash'),
(8, 8, 'Md', 'Hadiuzzaman', 'curesdokan', 'Bangladesh', 23, 'B s12', 'rangpur', 'rangpur', 5400, 1785304677, 'abc@gmail.com', 'i got it quickly', 'bank');
...
(2, 'abc', 'abc@gmail.com', '123456', '01785304677'),
(3, 'hadiuzzaman', 'abcd@gmail.com', '123456', '01785304677'),
(4, 'mantash mustarin', 'hadiuzzaman908@gmail.com', '123456', '01785304677');
